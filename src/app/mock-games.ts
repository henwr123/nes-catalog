...
export const GAMES: Game[] = [
    { id: 'NES-SM-USA', name: 'Super Mario Brothers', owned: true },
    { id: 'NES-DH-USA', name: 'Duck Hunt', owned: true },
    { id: 'NES-EB-USA', name: 'Excitebike', owned: false },
    { id: 'NES-GY-USA', name: 'Gyromite', owned: false },
    { id: 'NES-AL-USA', name: 'Zelda II: The Adventure of Link', owned: true },
    { id: 'NES-EI-USA', name: 'Tetris', owned: false },
    { id: 'NES-TY-USA', name: '10-Yard Fight', owned: false },
